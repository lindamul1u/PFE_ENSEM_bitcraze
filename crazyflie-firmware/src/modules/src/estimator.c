...
#define DEFAULT_ESTIMATOR kalmanENSEM
...
typedef struct {
  ...
  void (*update2)(state_t *state,X_t *X, sensorData_t *sensors, commande_t *commande, const uint32_t tick);
  const char* name;
