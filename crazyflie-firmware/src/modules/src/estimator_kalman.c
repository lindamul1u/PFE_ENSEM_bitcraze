...
static bool predictStateForward(uint32_t osTick, double dt);
...
static void kalmanTask(void* parameters) {
	...
	while (true) {
		...
		if (osTick >= nextPrediction) { // update at the PREDICT_RATE
			double dt = T2S(osTick - lastPrediction);
...
double x_tilde14=    0.002*c4 - 0.053240463*x13 + x14 + 0.053240463*y7;
	...
	(X->psi)=(X->x13);
	(X->dpsi)=(X->x14);
    double dpsi=x_tilde14;

	double cpsi=cos(x_tilde13);
	double spsi=sin(x_tilde13);
	double f=sqrt(x_tilde7*x_tilde7+x_tilde8*x_tilde8+(x_tilde9+9.81)*(x_tilde9+9.81));

	double x=(x_tilde9+9.81);
	double y=x_tilde7*cpsi+x_tilde8*spsi;
	...
	x=(x_tilde9+9.81)/ctheta;
	y=x_tilde7*spsi-x_tilde8*cpsi;

	double phi=atan2(y,x);
	(X->phi)=phi;
	double dphi=  x_tilde14*sin(theta) - (0.00004*fabs(f)*(20672.0*sin(x_tilde13 + 1.5708)*x_tilde7*x_tilde7 - 20672.0*x_tilde8*cos(x_tilde13 + 1.5708)*x_tilde7 + 20672.0*sin(x_tilde13 + 1.5708)*x_tilde9*x_tilde9 + 405580.0*sin(x_tilde13 + 1.5708)*x_tilde9 + 1.9894e+6*sin(x_tilde13 + 1.5708)))/(f*f*f*sqrt((x_tilde9 + 9.81)*(x_tilde9 + 9.81) + (x_tilde8*cos(x_tilde13 + 1.5708) - 1.0*x_tilde7*sin(x_tilde13 + 1.5708))*(x_tilde8*cos(x_tilde13 + 1.5708) - 1.0*x_tilde7*sin(x_tilde13 + 1.5708))));
    double dtheta= - (811170.0*cos(x_tilde13 + 1.5708)*fabs(f) + 82688.0*x_tilde9*cos(x_tilde13 + 1.5708)*fabs(f))/(100000*f*f*cos(phi)*sqrt((x_tilde9 + 9.81)*(x_tilde9 + 9.81) + (x_tilde8*cos(x_tilde13 + 1.5708) - 1.0*x_tilde7*sin(x_tilde13 + 1.5708))*(x_tilde8*cos(x_tilde13 + 1.5708) - 1.0*x_tilde7*sin(x_tilde13 + 1.5708)))) - (1.0*x_tilde14*cos(theta)*sin(phi))/cos(phi);

    (X->dphi)=dphi;
    (X->dtheta)=dtheta;

    double w1=-(0.00004*fabs(f)*(20672.0*sin(x_tilde13 + 1.5708)*x_tilde7*x_tilde7 - 20672.0*x_tilde8*cos(x_tilde13 + 1.5708)*x_tilde7 + 20672.0*sin(x_tilde13 + 1.5708)*x_tilde9*x_tilde9 + 405580.0*sin(x_tilde13 + 1.5708)*x_tilde9 + 1.9894e+6*sin(x_tilde13 + 1.5708)))/(f*f*f*sqrt((x_tilde9 + 9.81)*(x_tilde9 + 9.81) + (x_tilde8*cos(x_tilde13 + 1.5708) - 1.0*x_tilde7*sin(x_tilde13 + 1.5708))*(x_tilde8*cos(x_tilde13 + 1.5708) - 1.0*x_tilde7*sin(x_tilde13 + 1.5708))));
  double w2=-(0.001*cos(x_tilde13 + 1.5708)*fabs(f)*(82688.0*x_tilde9 + 811170.0))/(f*f*sqrt((100.0*x_tilde9 + 981.0)*(100.0*x_tilde9 + 981.0) + 10000.0*(x_tilde8*cos(x_tilde13 + 1.5708) - 1.0*x_tilde7*sin(x_tilde13 + 1.5708))*(x_tilde8*cos(x_tilde13 + 1.5708) - 1.0*x_tilde7*sin(x_tilde13 + 1.5708))));
   double w3=dpsi*cos(phi)*cos(theta) - 1.0*dtheta*sin(phi);
   X->w1=w1;
   X->w2=w2;
   X->w3=w3;
	xSemaphoreGive(dataMutex);
