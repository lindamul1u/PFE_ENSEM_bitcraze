...
# Stabilizer modules
PROJ_OBJ += commander.o crtp_commander.o crtp_commander_rpyt.o generateur_traj.o
...
PROJ_OBJ += controller.o controller_pid.o controller_mellinger.o controller_indi.o controller_ensem.o
